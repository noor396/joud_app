      ...
      child: Scaffold(
        body: Stack(
          children:[
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/Intro2_background.png',),
                      fit: BoxFit.cover
                  )
              ),
            ),
            Center(
              child: Card(
                child: Text(lan.getTexts('intro2_sentence'),style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:Colors.white),),
