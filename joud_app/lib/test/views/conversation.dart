      ...
      return Container(
        ...
        child: StreamBuilder(
          ...
          builder: (context, snapshot){
            return snapshot.hasData ?  ListView.builder( // to avoid returning null
                itemCount: snapshot.data.docs.length,
                itemBuilder: (context, index){
                  return MessageTile(
                    message: snapshot.data.docs[index].data()["message"],
                    isSenderMe: Constants.myName == snapshot.data.docs[index].data()["sender"],
                  );
                }) : Container();
          },
        ),
    ...
    if (messageController.text.isNotEmpty)
      {
        ...
        databaseMethods.addConversationMessages(widget.chatRoomId, messageMap, widget.msgReceiver);
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(color: Color.fromRGBO(166,155,151,1) ),
                        ),
    ...
    return Container(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: isSenderMe ? BorderRadius.only(
